...
<%
     ...
     while(rd.next()){
         %>
    <tr><td><%=rd.getString("user_id")%></td>
        <td><%=rd.getString("p_id")%></td>
        <td><%=rd.getString("p_name")%></td>
        <td><%=rd.getString("qty")%></td>
        <td><%=rd.getString("price")%></td>
        <td><%=rd.getString("status")%></td>
...
<div class="container">
	...
	<span>Copyright &copy; 2021<br> bootstrap ecommerce shopping template</span>
</div>
</div>
